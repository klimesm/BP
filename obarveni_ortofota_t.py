...
Některé části skriptu byly převzaty od autorů článku
Původní skripty jsou dostupné z odkazu: https://github.com/3DOM-FBK/Hyper_U_Net

Pozn. Tento skript je určen k obarvení ortofota pomocí natrénované sítě Hyper-U-Net.
      K použití je nutné mít ve stejné složce i soubor obsahující neuronovou síť (Hyper_U_NET_t.keras)
"""
...
class obarveni_ortofota:
    ...
    def edit_image(self):
        if self.original_image_path:
            ...
            model1 = load_model(cwd + '/Hyper_U_NET_t.keras')
